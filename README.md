...
<h1> 6.1 Поместите ваш Dockerfile и docker-compose.yml в репозиторий на GitHub.
  ...
  Скопировал репозиторий в рабочую директорию 

git clone git@github.com:nikolay2504/practic-work-5.7.git

Скопировал файлы, инициализировал репозиторий, сделал commit и загрузил на github. 
